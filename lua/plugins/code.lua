return {
  ...
  -- stylua: ignore
    keys = {
      { "<leader>cd", "", desc = "+[D]ebug", mode = {"n", "v"} },
  ...
  },
  {
    ...
    config = function()
      ...
      -- Keybind for reloading the snippets. This allows to have your document in one vim instance and edit the snippets in an other at the same time
      vim.keymap.set(
        'n',
        '<Leader>L',
      ...
      cmp.setup {
        ...
        mapping = cmp.mapping.preset.insert {
          ...
          -- <c-l> will move you to the next field of a expansion.
